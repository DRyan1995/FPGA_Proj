...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10010b8
SOPC_SYSID_FLAG += --sidp=0x10010b8
ELF_PATCH_FLAG  += --sidp 0x10010b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1450868559
SOPC_SYSID_FLAG += --timestamp=1450868559
ELF_PATCH_FLAG  += --timestamp 1450868559

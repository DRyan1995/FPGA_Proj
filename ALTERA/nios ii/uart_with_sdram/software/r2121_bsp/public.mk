...
SOPCINFO_FILE := D:/Proj/uart_with_sdram/CORE.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001088
SOPC_SYSID_FLAG += --sidp=0x1001088
ELF_PATCH_FLAG  += --sidp 0x1001088

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1450531025
SOPC_SYSID_FLAG += --timestamp=1450531025
ELF_PATCH_FLAG  += --timestamp 1450531025
